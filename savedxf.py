...
import svgwrite
import ezdxf
from geometry import PPfloat,autocadcolor,compresscurve,svg2png
from collections import defaultdict

def savemask(self,filename,txt=False,layers=[],layernames=[],svg=True,png=True,verbose=True,folder=None,dev=0,scalemag=1):
    if folder:
